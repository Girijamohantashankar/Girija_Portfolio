...
const projects = [
  ...
  },
  {
    ...
    summary:
      "This is a personal portfolio website built using React. The project showcases a collection of my work, skills, and experiences in web development. It features a clean and modern design with interactive elements, smooth transitions, and responsive layouts. The portfolio includes sections such as About Me, Projects, Skills, and Contact, allowing visitors to explore my work and get in touch. Leveraging the power of React, this portfolio provides a dynamic and seamless user experience across all devices.",
  ...
  },
  {
    ...
    demo: "https://girijamohantashankar.github.io/youtube_clone/",
  },
  {
    images: ["/images/web-101.png", "/images/web-101.png"],
    title: "Signup RGBA BGColor",
    summary:
      "I have built a signup page using HTML and CSS, where the background dynamically changes to an RGBA color effect. This page showcases a modern design approach by incorporating a semi-transparent background that adjusts its color based on the users interaction, enhancing the visual appeal and user experience. The combination of HTML for structure and CSS for styling allows for a sleek and responsive layout, making the signup process more engaging and aesthetically pleasing. This project demonstrates your ability to blend functionality with creativity in web design.",
    github: "https://github.com/Girijamohantashankar/signup-bgcolor-change.git",
    demo: "https://girijamohantashankar.github.io/signup-bgcolor-change/",
  },
  {
    images: [
      "/images/web-201.png",
  ...
  },
  {
    ...
    summary:
      "Developed a responsive portfolio website showcasing various projects and skills. Utilized HTML, CSS, and JavaScript to create an engaging, user-friendly interface. The site features adaptive layouts for various devices and screen sizes, ensuring a seamless user experience across desktop, tablet, and mobile platforms. Implemented interactive elements and smooth animations to enhance visual appeal and usability.",
    github: "https://github.com/Girijamohantashankar/portfolio.github.io.git",
    demo: "https://girijamohantashankar.github.io/portfolio.github.io/",
  },
  {
    images: [
      "/images/web-501.png",
    ...
    github:
      "https://github.com/Girijamohantashankar/Protien-website.github.io.git",
    demo: "https://girijamohantashankar.github.io/Protien-website.github.io/",
  },
  {
    images: ["/images/web-601.png", "/images/web-602.png"],
    title: "Food Website",
    summary:
    ...
    github:
      "https://github.com/Girijamohantashankar/Find_Your_Food.github.io.git",
    demo: "https://girijamohantashankar.github.io/Find_Your_Food.github.io/",
  },
  {
    images: ["/images/web-701.png", "/images/web-702.png"],
    title: "College library management system",
    summary:
      "Developed a comprehensive college library management system using HTML, CSS, and JavaScript. The application provides features such as browsing and searching for books, viewing detailed book information, and managing library records. Utilized HTML and CSS to create a structured and visually appealing interface, and JavaScript to implement interactive elements and dynamic functionality, such as search filters and user interactions. The system enhances the user experience with responsive design and intuitive navigation.",
    github:
      "https://github.com/Girijamohantashankar/CollegeLibrary.github.io-.git",
    demo: "https://girijamohantashankar.github.io/CollegeLibrary.github.io-/",
  },
  {
    images: [
      "/images/web-801.png",
  ...
  return (
    <div className="projects_container">
      <div className="recent_work">
        <h1>
          Responsive Web<span>Project</span> Works
        </h1>
        <p>
          Here are a few <span className="span_text">Web projects</span> I have
          worked on recently.
        </p>
